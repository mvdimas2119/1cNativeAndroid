package ru.infostart.education3.device;
...
import ru.infostart.education3.LockState;
...
public class VH73Device {
	...
	private LockState activity;

	public VH73Device(LockState activity, BluetoothDevice device) {
		this.bluetoothDevice = device;
